...
# see https://github.com/PetterTech/DemoStuff/tree/main/Write-Progress
# pwsh -Command "Measure-Command { .\writeprogresstry-withwriteprogress-subprocesses.ps1 } | Format-Table TotalSeconds"
...
# copy-item -path "P:\Game-Library-Auto-Archiver\test env - source large game folders ref\*" -destination "P:\Game-Library-Auto-Archiver\GameSource" -recurse
# copy-item -path "P:\Game-Library-Auto-Archiver\test env - dest game folders ref\*" -destination "P:\Game-Library-Auto-Archiver\GameDest" -recurse

# Remove-Item -Path "P:\Game-Library-Auto-Archiver\GameSource\*" -Force -Recurse
# Remove-Item -Path "P:\Game-Library-Auto-Archiver\GameDest\*" -Force -Recurse
